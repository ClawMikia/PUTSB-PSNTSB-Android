...
import com.cyberpunk.debttracker.ui.dashboard.MainActivity_GeneratedInjector;
...
public final class DebtTrackerApp_HiltComponents {
  private DebtTrackerApp_HiltComponents() {
  }
  ...
  @Singleton
  public abstract static class SingletonC implements DebtTrackerApp_GeneratedInjector,
  ...
  @Subcomponent(
      modules = {
          AddDebtViewModel_HiltModules.KeyModule.class,
  ...
  @Subcomponent(
      modules = {
          AddDebtViewModel_HiltModules.BindsModule.class,
