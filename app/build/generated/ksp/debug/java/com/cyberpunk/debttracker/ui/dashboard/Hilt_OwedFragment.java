...
public abstract class Hilt_OwedFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((OwedFragment_GeneratedInjector) this.generatedComponent()).injectOwedFragment(UnsafeCasts.<OwedFragment>unsafeCast(this));
    }
  }
