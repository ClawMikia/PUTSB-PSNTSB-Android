...
public final class DaggerDebtTrackerApp_HiltComponents_SingletonC {
  ...
  public static final class Builder {
    ...
    public DebtTrackerApp_HiltComponents.SingletonC build() {
      Preconditions.checkBuilderRequirement(applicationContextModule, ApplicationContextModule.class);
      return new SingletonCImpl(applicationContextModule);
    }
  }

  private static final class ActivityRetainedCBuilder implements DebtTrackerApp_HiltComponents.ActivityRetainedC.Builder {
    ...
    @Override
    public DebtTrackerApp_HiltComponents.ActivityRetainedC build() {
      Preconditions.checkBuilderRequirement(savedStateHandleHolder, SavedStateHandleHolder.class);
      return new ActivityRetainedCImpl(singletonCImpl, savedStateHandleHolder);
    }
  }

  private static final class ActivityCBuilder implements DebtTrackerApp_HiltComponents.ActivityC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public DebtTrackerApp_HiltComponents.ActivityC build() {
      Preconditions.checkBuilderRequirement(activity, Activity.class);
      return new ActivityCImpl(singletonCImpl, activityRetainedCImpl, activity);
    }
  }

  private static final class FragmentCBuilder implements DebtTrackerApp_HiltComponents.FragmentC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public DebtTrackerApp_HiltComponents.FragmentC build() {
      Preconditions.checkBuilderRequirement(fragment, Fragment.class);
      return new FragmentCImpl(singletonCImpl, activityRetainedCImpl, activityCImpl, fragment);
    }
  }

  private static final class ViewWithFragmentCBuilder implements DebtTrackerApp_HiltComponents.ViewWithFragmentC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public DebtTrackerApp_HiltComponents.ViewWithFragmentC build() {
      Preconditions.checkBuilderRequirement(view, View.class);
      return new ViewWithFragmentCImpl(singletonCImpl, activityRetainedCImpl, activityCImpl, fragmentCImpl, view);
    }
  }

  private static final class ViewCBuilder implements DebtTrackerApp_HiltComponents.ViewC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public DebtTrackerApp_HiltComponents.ViewC build() {
      Preconditions.checkBuilderRequirement(view, View.class);
      return new ViewCImpl(singletonCImpl, activityRetainedCImpl, activityCImpl, view);
    }
  }

  private static final class ViewModelCBuilder implements DebtTrackerApp_HiltComponents.ViewModelC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public DebtTrackerApp_HiltComponents.ViewModelC build() {
  ...
  private static final class ServiceCBuilder implements DebtTrackerApp_HiltComponents.ServiceC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public DebtTrackerApp_HiltComponents.ServiceC build() {
      Preconditions.checkBuilderRequirement(service, Service.class);
      return new ServiceCImpl(singletonCImpl, service);
    }
  }

  private static final class ViewWithFragmentCImpl extends DebtTrackerApp_HiltComponents.ViewWithFragmentC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class FragmentCImpl extends DebtTrackerApp_HiltComponents.FragmentC {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public void injectLentFragment(LentFragment lentFragment) {
    }

    @Override
    public void injectOwedFragment(OwedFragment owedFragment) {
    }
  ...
  private static final class ViewCImpl extends DebtTrackerApp_HiltComponents.ViewC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class ActivityCImpl extends DebtTrackerApp_HiltComponents.ActivityC {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public void injectAddDebtActivity(AddDebtActivity addDebtActivity) {
    }
    ...
    @Override
    public void injectDebtDetailActivity(DebtDetailActivity debtDetailActivity) {
    }
  ...
  private static final class ViewModelCImpl extends DebtTrackerApp_HiltComponents.ViewModelC {
    private final SingletonCImpl singletonCImpl;
    ...
    private void initialize(final SavedStateHandle savedStateHandleParam,
      ...
      this.addDebtViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 0);
      this.debtDetailViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 1);
      this.debtViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 2);
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.cyberpunk.debttracker.ui.adddebt.AddDebtViewModel 
          return (T) new AddDebtViewModel(singletonCImpl.debtRepositoryProvider.get(), ApplicationContextModule_ProvideApplicationFactory.provideApplication(singletonCImpl.applicationContextModule));

          case 1: // com.cyberpunk.debttracker.ui.debtdetail.DebtDetailViewModel 
          return (T) new DebtDetailViewModel(singletonCImpl.debtRepositoryProvider.get());

          case 2: // com.cyberpunk.debttracker.ui.dashboard.DebtViewModel 
          return (T) new DebtViewModel(singletonCImpl.debtRepositoryProvider.get());
  ...
  private static final class ActivityRetainedCImpl extends DebtTrackerApp_HiltComponents.ActivityRetainedC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class ServiceCImpl extends DebtTrackerApp_HiltComponents.ServiceC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class SingletonCImpl extends DebtTrackerApp_HiltComponents.SingletonC {
    private final ApplicationContextModule applicationContextModule;

    private final SingletonCImpl singletonCImpl = this;

    private Provider<DebtDatabase> provideDebtDatabaseProvider;
    ...
    private Map<String, javax.inject.Provider<WorkerAssistedFactory<? extends ListenableWorker>>> mapOfStringAndProviderOfWorkerAssistedFactoryOf(
      ...
      return Collections.<String, javax.inject.Provider<WorkerAssistedFactory<? extends ListenableWorker>>>singletonMap("com.cyberpunk.debttracker.notification.OverdueReminderWorker", ((Provider) overdueReminderWorker_AssistedFactoryProvider));
    }
    ...
    @Override
    public void injectDebtTrackerApp(DebtTrackerApp debtTrackerApp) {
      injectDebtTrackerApp2(debtTrackerApp);
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.cyberpunk.debttracker.notification.OverdueReminderWorker_AssistedFactory 
          return (T) new OverdueReminderWorker_AssistedFactory() {
            @Override
            public OverdueReminderWorker create(Context context, WorkerParameters workerParams) {
              return new OverdueReminderWorker(context, workerParams, singletonCImpl.debtRepositoryProvider.get());
            }
          };
