...
public final class DaggerDebtTrackerApp_HiltComponents_SingletonC {
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          return (T) new AddDebtViewModel(singletonCImpl.debtRepositoryProvider.get());
  ...
  private static final class SingletonCImpl extends DebtTrackerApp_HiltComponents.SingletonC {
    ...
    private void initialize(final ApplicationContextModule applicationContextModuleParam) {
      this.provideDebtDatabaseProvider = DoubleCheck.provider(new SwitchingProvider<DebtDatabase>(singletonCImpl, 2));
      this.provideDebtDaoProvider = DoubleCheck.provider(new SwitchingProvider<DebtDao>(singletonCImpl, 1));
      this.debtRepositoryProvider = DoubleCheck.provider(new SwitchingProvider<DebtRepository>(singletonCImpl, 0));
    }
