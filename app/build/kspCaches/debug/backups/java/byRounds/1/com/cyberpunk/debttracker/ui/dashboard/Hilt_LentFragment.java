...
public abstract class Hilt_LentFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((LentFragment_GeneratedInjector) this.generatedComponent()).injectLentFragment(UnsafeCasts.<LentFragment>unsafeCast(this));
    }
  }
