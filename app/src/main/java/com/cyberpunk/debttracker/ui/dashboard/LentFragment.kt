...
import com.cyberpunk.debttracker.databinding.FragmentLentBinding
...
class LentFragment : Fragment() {
    ...
    private var _binding: FragmentLentBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentLentBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    private fun setupRecycler() {
        ...
        binding.recyclerDebts.apply {
            ...
            this.adapter = this@LentFragment.adapter
        }
    }
    ...
    private fun observeViewModel() {
        viewLifecycleOwner.lifecycleScope.launch {
            repeatOnLifecycle(Lifecycle.State.STARTED) {
                ...
                launch {
                    viewModel.lentDebts.collect { debts ->
